...
# We use a custom source-read handler to replace strings in code blocks that
# can't be replaced with Sphinx variables.
def custom_replace(app, docname, source):
    result = source[0]
...
def setup(app):
    ...
    app.connect('source-read', custom_replace)
