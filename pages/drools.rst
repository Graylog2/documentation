...
===============
  ...
  #. Copy the `sample rules file <https://github.com/Graylog2/graylog2-server/blob/1.3/misc/graylog2.drl>`_ to the location specified in your Graylog configuration file.
