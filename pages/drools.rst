...
===============
  ...
  #. Copy the `sample rules file <https://github.com/Graylog2/graylog2-server/blob/2.2/misc/graylog.drl>`_ to the location specified in your Graylog configuration file.
