...
.. note:: This input is available for Graylog Enterprise version 2.5.0.  Installation of an additional ``graylog-plugin-enterprise-integrations`` package is required. See the :doc:`Enterprise Setup <../../enterprise/setup>` page for more info.
