...
* `Elasticsearch 2.x (2.1.0 or later, but not 2.4.0 or later) <https://www.elastic.co/downloads/elasticsearch>`_
...
.. warning:: Graylog 2.0.x currently **does not** work with Elasticsearch 2.4.x or 5.x. The latest supported version is `Elasticsearch 2.3.5 <https://www.elastic.co/downloads/past-releases/elasticsearch-2-3-5>`_.
