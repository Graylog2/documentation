...
* `MongoDB 3.6 or 4.0 <https://docs.mongodb.org/manual/administration/install-on-linux/>`_ 
...
.. hint:: Graylog 3.x does work with MongoDB 4.2 when this runs in compatibility mode 4.0