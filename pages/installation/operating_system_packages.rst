...
.. hint:: We assume that you had placed the GPG-Key in `/etc/pki/rpm-gpg/RPM-GPG-KEY-graylog`

Now create a `/etc/yum.repos.d/graylog.repo` file with the following content::
