...
Download and install `graylog-2.5-repository_latest.deb <https://packages.graylog2.org/repo/packages/graylog-2.5-repository_latest.deb>`_
...
Now create a file ``/etc/apt/sources.list.d/graylog.list`` with the following content::
  ...
  deb https://packages.graylog2.org/repo/debian/ stable 2.5
...
Download and install `graylog-2.5-repository_latest.rpm <https://packages.graylog2.org/repo/packages/graylog-2.5-repository_latest.rpm>`_
via ``rpm(8)``::
