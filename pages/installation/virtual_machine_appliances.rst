...
Download the `OVA image <https://packages.graylog2.org/appliances/ova>`_. If you are unsure what the latest version number is, take a look at our `release page <http://docs.graylog.org/en/latest/pages/changelog.html>`__.
