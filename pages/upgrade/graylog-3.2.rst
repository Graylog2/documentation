...
==========================
  ...
  * Some functionality of the search has been removed, namely:
    * Stacked charts are not supported in the same was as pre-3.2. Charts do support multiple metrics and pivots, but you cannot merge two charts by dragging & dropping them.
