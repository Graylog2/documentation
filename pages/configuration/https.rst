...
Converting a PFX file to private key and certificate pair
=========================================================
PFX files are commonly generated by Windows. In this example your pfx file is named keystore.pfx::
...
You'll need to use **graylog-certificate.pem** and **graylog-key.pem** in the graylog.conf file.
